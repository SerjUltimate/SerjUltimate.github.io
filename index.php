...
<h1><font color="white">САЙТ СЕРГЕЯ НАЗАРОВА</font></h1>
<h3><font color="white">Группа 3-1 КСК</font></h3>
<!--Закрываем таблицу-->
</th>
</tr>
</table>
...
Приветствую, друзья! Меня зовут Сергей. И на данном сайте я представлю немного информации о себе, покажу свои проекты в графическом дизайне, на данный момент испытываю себя в сфере Web-дизайна.</p>

<p style="text-indent:20px">Данные занятия являются очень интересными и познавательными.
А в настоящее время в век информационных технологий данная деятельность является весьма значимой.
Однако, чтобы хорошо освоиться, нужно изучить программы, с которыми работаем, зарядиться базовыми знаниями и потихоньку познавать и изучать новое.</p>
<!--Закрываем ячейку-->
</td>
...
<!--Создаём столбец-->
<th>
<h3><font color="white">Сайт моего колледжа</font></h3>
<p><font style color="white"><a href="http://www.semk13.ru/" style="color: white">semk13.ru</font></a></p>
